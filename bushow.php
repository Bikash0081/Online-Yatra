...
<body>
  ...
  <div class="container-fluid bg-light no-result p-4 mt-5">
    ...
    <?php }
              ...
              {?>
    <h4 class="alert">Sorry, we didn't find any buses for your searched routes and date. Please Search Again.</h4>
    <?php  
              }?>
  </div>
