...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-light fixed-top scroll-color">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav mr-auto mx-auto text-center ">
        ...
        <li class="nav-item mx-4 my-2">
          <a class="nav-link text-uppercase font-weight-bold" href="contact.php">Contact</a>
        </li>
      </ul>
      <?php 
  ...
  <form action="" method="POST" class="seatform">
    ...
    <input value="<?php echo $row['bus_id'] ?>" name="pid" type="hidden">
    <input value="http://localhost/Bus%Booking%V1/getpdf.php" type="hidden" name="su">
    <input value="http://merchant.com.np/page/esewa_payment_failed?q=fu" type="hidden" name="fu"> -->
      ...
      <h5> Booked seat no: <?php echo $name['seatnoextra']?> [You can't book this seats] </h5>
